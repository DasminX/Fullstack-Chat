...
const ModalContent: ModalMessageType = ({ message, hideModalHandler }) => {
  return (
    <div className="bg-slate-300 rounded-2xl w-1/3 h-1/3 fixed top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 border-4 border-red-500 p-10 flex flex-col justify-around items-center text-2xl">
      <h1>{message}</h1>
      <button
